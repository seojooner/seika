...
from .. import (  # ".." - т.к. модули находятся в папке seika/modules, то нам нужно на уровень выше
    loader, utils)

                            # loader, modules, bot - файлы из папки seika


@loader.module(name="Example", author="seika", version=1)  # name модуля ("name" обязательный аргумент, остальное — нет), author - автор, version - версия
