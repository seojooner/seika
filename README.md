<p align="center">
    <br>
    <b>Seika UserBot</b> — крутой юзербот написанный на <a href="https://github.com/pyrogram/pyrogram">Pyrogram</a>
    <br>
</p>
...
Seika — это ваш интерактивный многофункциональный помощник в Телеграме  
...
<pre lang="bash">
git clone https://github.com/seojooner/seika && cd seika 
...
> Больше примеров функций и полное описание смотри в файле <a href="./seika/modules/example.py">example.py</a>
