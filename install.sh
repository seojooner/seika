...
echo "[INFO] cloning https://github.com/seojooner/seika..." > install.log
echo "[INFO] cloning repository..."
eval "git clone https://github.com/seojooner/seika"
eval "cd seika"
...
echo "[INFO] first start seika..." > install.log
echo "[INFO] first start..."
clear
eval "python3 -m seika"